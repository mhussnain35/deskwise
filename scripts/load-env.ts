 ...
 * does not. Without this the CLI scripts saw no GEMINI_API_KEY, QDRANT_URL or
 * DATABASE_URL, so `scripts/ingest.ts` quietly embedded the whole knowledge
 ...
 * (lib/db, lib/qdrant/client, lib/ai/gemini all do).
 */
